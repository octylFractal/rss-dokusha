...
public class DokushaCommServerTest {
    private DokushaCommServer commServer;
    private UnixSocketDokushaIpc clientA;
    private UnixSocketDokushaIpc clientB;
